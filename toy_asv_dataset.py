...
def asv_toys(ROOT='ToyASV2019', sample_size=None, download=True):
  """
  ...
  asv_train = ToyASVDataset(ROOT, ROOT, feature_name='toy', partition='train', sample_size=sample_size, CACHE_DIR=ROOT)
  asv_dev = ToyASVDataset(ROOT, ROOT, feature_name='toy', partition='dev', sample_size=sample_size, CACHE_DIR=ROOT)
  asv_eval = ToyASVDataset(ROOT, ROOT, feature_name='toy', partition='eval', sample_size=sample_size, CACHE_DIR=ROOT)
